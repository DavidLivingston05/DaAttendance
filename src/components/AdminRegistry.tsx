    ...
    <div className="space-y-6 font-sans">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 bg-white dark:bg-[#191433]/85 border border-slate-200 dark:border-purple-500/20 rounded-2xl p-5 shadow-xl">
          ...
          <div className="flex justify-between items-center pb-3 border-b border-slate-100 dark:border-purple-500/10 mb-4 bg-slate-50/50 dark:bg-[#130F26] px-3 py-2 rounded-xl border dark:border-purple-500/10">
            <div>
